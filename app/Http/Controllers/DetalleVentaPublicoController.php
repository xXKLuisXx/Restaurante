...
class DetalleVentaPublicoController extends Controller
{
    ...
    public function create(){
        ...
        return view("ventasP.create",['clientes'=>$clientes]);
    } 
    public function store(DetalleVentaRequest $request){
        ...
        $clientes=DB::table('cliente')->where('activo','=','1')->get();
        return view('detalleCP.index',['clientes'=>$clientes,'venta'=>venta::findOrFail($id_venta),'disponibles'=>$producto,'id_venta'=>$id_venta,'productos'=>$productosCarrito]); 
    }
    public function show($id){
        return view("detalleCP.show",["detalle"=>detalleventa::findOrFail($id)]);
    }
    public function edit($id){
        $producto=DB::table('producto as p')
                ...
                ->where('p.activo','=',1)
                ->orderBy('p.id_producto','desc')->get();
        return view("detalleCP.edit",["venta"=>detalleventa::findOrFail($id),'disponibles'=>$producto]);
    }
