...
@section ('contenido')
    ...
    <div class="col l12 m12 s12 lx12">
        ...
        {!!Form::model($producto,['method'=>'PATCH','route'=>['menu.update',$producto->id_producto]])!!}
        {{Form::token()}}
           ...
           <div class="input-field col s12">
                <textarea id="descripcion" class="materialize-textarea" name="descripcion">{{$producto->descripcion}}</textarea>
